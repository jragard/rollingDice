...
function times(fn, numOfTimes) {
    // Return an array whose length if numOfTimes, and each item is a fn() results
...
function createBarGraph(object) {
  ...
  function execute(nSidedDie, sumOfNRolls, nNumberOfTimes) {
